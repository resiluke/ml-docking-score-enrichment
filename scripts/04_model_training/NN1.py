...
# ============================================================
# NN1_in_vivo_5fold_final_invitro_test.py
# ============================================================
# This script trains the NN1 neural network model using five-fold
# cross-validation on the in vivo dataset.
#
...
def build_model(input_dim):
    """Create the NN1 neural network architecture."""
...
# ============================================================
# 2. LOAD ALL IN-VIVO DATA FOR SOAP SPECIES DEFINITION
# ============================================================

print(">> Loading all in-vivo data for SOAP species...")
...
# ============================================================
# 4. FIVE-FOLD CROSS-VALIDATION ON IN VIVO DATA
# ============================================================
...
for fold in range(1, 6):
    ...
    train_file = f"in_vivo_80_{fold:02d}_train.xyz"
    val_file = f"in_vivo_20_{fold:02d}_test.xyz"

    checkpoint_path = f"NN1_fold{fold}_best.keras"
    final_model_path = f"NN1_fold{fold}_final.keras"
    csv_name = f"in_vitro_20_NN1_fold{fold}.csv"

    # Load training and validation structures
    ...
    # Load best model according to validation loss
    ...
    # Predict independent final in vitro test set
...
np.save("NN1_in_vivo_5fold_results.npy", fold_results)